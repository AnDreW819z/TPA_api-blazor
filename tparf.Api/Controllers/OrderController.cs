...
namespace tparf.Api.Controllers
{
    ...
    public class OrderController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<OrderItemDto>>> GetOrderItems(long orderId)
        {
            try
            {
        ...
        [HttpGet]
        [Route("getStatuses")]
        public async Task<ActionResult<IEnumerable<OrderStatusDto>>> GetSatuses()
        {
            try
            {
